...
public class IntentReaderActivityTest extends ActivityInstrumentationTestCase2{
    ...
    public void testReverseText(){
        ...
        IntentReaderActivity intentReaderActivity = (IntentReaderActivity) getActivity();
        assertEquals("The text should be reversed!","5 egassem tseT",intentReaderActivity.getText());
    }
    ...
    public void testDefaultText(){
        ...
        IntentReaderActivity intentReaderActivity = (IntentReaderActivity) getActivity();
        assertEquals("The text should be reversed!","default value",intentReaderActivity.getText());
    }
